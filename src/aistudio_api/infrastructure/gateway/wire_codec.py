...
class AistudioWireCodec:
    ...
    def rewrite(
        ...
        explicit_thinking = (
            generation_config_overrides is not None
            and "thinking_config" in generation_config_overrides
        )
        ...
        if not explicit_thinking:
            ...
            request.generation_config.thinking_config is not None
            and request.generation_config.request_flag is None
        ):
            request.generation_config.request_flag = 1
